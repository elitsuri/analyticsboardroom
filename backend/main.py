"""
AnalyticsBoardroom - Backend API
A business intelligence SaaS with drag-and-drop dashboards
"""
...
app = FastAPI(
    title="AnalyticsBoardroom",
    description="A business intelligence SaaS with drag-and-drop dashboards",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "AnalyticsBoardroom"}
